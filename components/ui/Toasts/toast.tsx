...
import { ToastContainer as DesignToastContainer, Toast as DesignToast, type ToastProps, type ToastType } from '@/components/ui/design-system/primitives';
    ...
    <div className="fixed bottom-6 end-6 z-50 flex flex-col gap-2" role="region" aria-label="Notifications">
      {toasts.map((toast) => (
        <DesignToast
          ...
          onClose={() => dispatch({ type: 'DISMISS_TOAST', toastId: toast.id })}
        />
      ))}
    </div>
  );
