...
export default function PatientWorkspaceSkeleton() {
  return (
    <div className="space-y-6 min-h-screen pb-16 text-left animate-pulse">
      {/* 1. Header Skeleton */}
      <div className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-900 px-4 py-3 sm:px-6 flex flex-wrap items-center justify-between gap-3 shadow-lg shadow-black/25">
        ...
        <div className="flex items-center gap-4 text-xs font-mono shrink-0 ml-auto sm:ml-0">
          <div className="w-28 h-8 bg-zinc-900 rounded border-l border-zinc-900 pl-4" />
          <div className="w-28 h-8 bg-zinc-900 rounded border-l border-zinc-900 pl-4" />
        </div>
      </div>
      ...
      <div className="p-6 rounded-3xl border border-zinc-900 bg-zinc-900/5 space-y-4">
        ...
        <div className="relative pl-8 space-y-6 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-zinc-900">
