...
export default function PatientDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <form onSubmit={onSubmit} className="bg-zinc-950 border border-zinc-900 p-6 rounded-2xl w-full max-w-xl space-y-4 text-xs text-left max-h-[90vh] overflow-y-auto scrollbar-thin">
