      ...
      <div className="md:col-span-4 space-y-4">
        <div className="p-4 card-elevated rounded-2xl">
          ...
          {isLoading ? (
            ...
            <p className="text-zinc-500 text-xs py-4">No surgical referrals or physician letters on file.</p>
          ) : (
              ...
              {referrals.map((ref) => (
                ...
                >
                  <div className="flex justify-between items-center mb-1.5">
                    <span className="text-2xs font-mono font-semibold text-zinc-500">{ref.date}</span>
                    <span className={`text-2xs font-mono px-1.5 py-0.5 rounded border uppercase ${
        ...
        {!activeReferral ? (
          ...
          <div className="p-5 card-elevated rounded-3xl space-y-6">
            ...
            <div className="flex justify-between items-start border-b border-zinc-900/60 pb-3">
              <div>
                <span className="text-2xs font-mono text-zinc-500">File ID: {activeReferral.id}</span>
              ...
              <div className="space-y-3">
                ...
                {showRequestBox && (
                  <div className="p-3 card-elevated rounded-2xl space-y-2">
                    <label className="text-2xs text-zinc-400 block font-bold">Specify Information Request Details</label>
                    <div className="flex gap-2">
                      <input
                        type="text"
            ...
            <div className="space-y-3 pt-2">
              <h4 className="text-2xs font-bold text-zinc-500 uppercase tracking-wider font-mono">Referral Status Timeline & Audit Log</h4>
              <div className="space-y-3 relative ps-3.5 before:absolute before:start-1 before:top-2 before:bottom-2 before:w-0.5 before:bg-zinc-900">
