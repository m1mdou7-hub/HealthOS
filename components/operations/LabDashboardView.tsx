  ...
  return (
    <div className="space-y-6 text-zinc-100">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {delayedCases.map(c => (
                <button
                  ...
                  className="px-2.5 py-1 rounded bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 text-[10px] font-mono border border-rose-500/30 flex items-center gap-1.5 transition-all"
                >
      ...
      <div id="lab-kpi-grid" className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4 bg-zinc-900/40 border border-zinc-900 rounded-2xl text-left space-y-2">
          <div className="flex justify-between items-center text-zinc-400">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider">Active restorations</span>
            <Activity className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="space-y-0.5">
            <h3 className="text-2xl font-black font-mono text-white">{activeCasesCount}</h3>
            <p className="text-[10px] text-zinc-500 font-mono">In CAD/CAM workflow</p>
          </div>
        </div>

        <div className="p-4 bg-zinc-900/40 border border-zinc-900 rounded-2xl text-left space-y-2">
          <div className="flex justify-between items-center text-zinc-400">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider">Urgent Priority</span>
            <span className="w-2.5 h-2.5 rounded-full bg-rose-500 animate-pulse" />
          </div>
          <div className="space-y-0.5">
            <h3 className="text-2xl font-black font-mono text-rose-400">{urgentCasesCount}</h3>
            <p className="text-[10px] text-zinc-500 font-mono">Immediate manufacturing priority</p>
          </div>
        </div>

        <div className="p-4 bg-zinc-900/40 border border-zinc-900 rounded-2xl text-left space-y-2">
          <div className="flex justify-between items-center text-zinc-400">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider">Pending Approvals</span>
            <CheckCircle2 className="w-4 h-4 text-purple-400" />
          </div>
          <div className="space-y-0.5">
            <h3 className="text-2xl font-black font-mono text-purple-300">{pendingApprovalsCount}</h3>
            <p className="text-[10px] text-zinc-500 font-mono">Clinician signature required</p>
          </div>
        </div>

        <div className="p-4 bg-zinc-900/40 border border-zinc-900 rounded-2xl text-left space-y-2">
          <div className="flex justify-between items-center text-zinc-400">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider">Average Dispatch</span>
            <Clock className="w-4 h-4 text-sky-400" />
          </div>
          <div className="space-y-0.5">
            <h3 className="text-2xl font-black font-mono text-white">4.2 Days</h3>
            <p className="text-[10px] text-zinc-500 font-mono">Cycle turnaround rate</p>
          </div>
        </div>
      </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      {c.isDelayed && (
                        <span className="text-[8px] font-mono px-1.5 py-0.2 bg-rose-500/10 text-rose-400 border border-rose-500/20 rounded font-bold uppercase animate-pulse">
                          Delayed
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center gap-4 justify-between md:justify-end">
                  <div className="space-y-1 text-right">
                    <span className="text-[9px] font-mono text-zinc-500 uppercase block font-bold">Stage</span>
                  ...
                  <div className="space-y-1 text-right">
                    <span className="text-[9px] font-mono text-zinc-500 uppercase block font-bold">Progress</span>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono font-bold text-white">{c.progressPercent}%</span>
                    </div>
                  </div>

                  <div className="space-y-1 text-right hidden sm:block">
                    <span className="text-[9px] font-mono text-zinc-500 uppercase block font-bold">Technician</span>
                    <p className="text-xs text-zinc-300">{c.assignedTechnician}</p>
                  </div>

                  <div className="space-y-1 text-right">
                    <span className="text-[9px] font-mono text-zinc-500 uppercase block font-bold">Due Date</span>
                ...
                <div className="flex justify-between items-center text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-zinc-500 font-mono">Active: {tech.activeCases} • Done Today: {tech.completedToday}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-emerald-400 font-mono">{tech.utilizationRate}%</p>
                    <p className="text-[8px] text-zinc-500 font-mono">Capacity</p>
                  </div>
                </div>
